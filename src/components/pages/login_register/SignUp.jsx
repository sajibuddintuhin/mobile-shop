...
const SignUp = () => {
  ...
  return (
    <div>
      <div className="w-full mx-auto my-10 max-w-md p-8 space-y-3 rounded-xl dark:bg-[#8aba8e] dark:text-black">
        <h1 className="text-2xl font-bold text-center">Login</h1>
        <form onSubmit={handleSignUp} className="space-y-6">
          <div className="space-y-1 text-sm">
            <label className="block dark:text-black">Name</label>
            <input
              type="name"
              name="name"
              placeholder="Name"
              className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-[#f3f4f3] dark:text-black focus:dark:border-violet-400"
            />
          </div>
          <div className="space-y-1 text-sm">
            <label className="block dark:text-black">Email</label>
            <input
              type="email"
              name="email"
              required
          ...
          <div className="space-y-1 text-sm">
            <label className="block dark:text-black">Password</label>
            <input
              type="password"
              name="password"
              required
        ...
        <p className="text-xs text-center sm:px-6 dark:text-black">
